...
<body>
    ...
    <header class="header_BOO">
        ...
        <div class="search">
            ...
            <button class="search__button" onclick="window.location.href='../SearchPage/searchPage.html';">Search
                Book</button>
        </div>

        <nav class="nav">
            <ul class="nav__list">
                <li class="nav__item"><a href="../Library/index.html" class="nav__link">Library</a></li>
                <li class="nav__item"><a href="../LookForGroupPage/lookFor.html" class="nav__link">Groups</a></li>
                <li class="nav__item"><a href="../AccountPage/account.html" class="nav__link">Account</a></li>
            ...
            <div class="nav__item_special">
                ...
                <ul class="nav_dropdown">
                    <li class="nav__item"><a href="../Library/index.html" class="nav__link">Library</a></li>
                    <li class="nav__item"><a href="../LookForGroupPage/lookFor.html" class="nav__link_menu">Groups</a>
                    </li>
                    <li class="nav__item"><a href="../AccountPage/account.html" class="nav__link_menu">Account</a></li>
                    <li class="nav__item"><a href="../Settings/settings.html" class="nav__link_menu">Settings</a></li>
                    <li class="nav__item"><a href="../AboutPage/aboutpage.html" class="nav__link_menu">About</a></li>
                </ul>
            </div>
        ...
        <div class="feed_container">
                ...
                <div class="feed_container_side_">
                    <div class="profile">
                        ...
                        <ul class="group__list" id="current-groups">
                            <!-- Current groups will be dynamically loaded here -->
                        </ul>
            ...
            <div class="feed_container_main_feed">
                ...
                <div class="friend__container" id="open-groups">
                    <!-- Open groups will be dynamically loaded here -->
                </div>
            </div>
        </div>
    </div>
